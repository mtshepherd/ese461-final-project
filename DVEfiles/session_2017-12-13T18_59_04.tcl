...
# DVE full session
# Saved on Wed Dec 13 18:59:04 2017
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{225 177} {1188 716}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 335} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 336
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 105} {height 335} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 963} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_1" { Top_tb.clk Top_tb.reset Top_tb.enable Top_tb.we Top_tb.wdata Top_tb.waddr Top_tb.inputs Top_tb.weights1 Top_tb.weights2 Top_tb.i Top_tb.j Top_tb.k Top_tb.error }
...
# Restore C1 time
gui_set_time -C1_only 962338896
